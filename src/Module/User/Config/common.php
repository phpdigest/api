...
use App\Module\User\Domain\Repository\IdentityTokenRepository;
...
return [
    ...
    IdentityTokenRepository::class => static fn (ContainerInterface $container)
        => $container->get(ORMInterface::class)->getRepository(Token::class),
